...
scada.scheme.Renderer.prototype.setBackColor = function (
	jqObj,
	backColor,
	opt_removeIfEmpty,
	opt_statusColor,
	...
	if (backColor) {
		if (backColor === this.STATUS_COLOR) {
			jqObj.css(
				"background-color",
				opt_statusColor ? opt_statusColor : this.STATUS_DISPLAY_COLOR,
			);
...
scada.scheme.Renderer.prototype.setBorderColor = function (
	jqObj,
	borderColor,
	opt_removeIfEmpty,
	opt_statusColor,
...
scada.scheme.Renderer.prototype.setBorderWidth = function (
	jqObj,
	borderWidth,
	opt_removeIfEmpty,
) {
...
scada.scheme.Renderer.prototype.setForeColor = function (
	jqObj,
	foreColor,
	opt_removeIfEmpty,
	opt_statusColor,
...
scada.scheme.Renderer.prototype.setFont = function (
	jqObj,
	font,
	opt_removeIfEmpty,
) {
...
scada.scheme.Renderer.prototype.setBackgroundImage = function (
	jqObj,
	image,
	opt_removeIfEmpty,
) {
...
scada.scheme.Renderer.prototype.imageToDataURL = function (image) {
	return image
		? "data:" +
				(image.MediaType ? image.MediaType : "image/png") +
				";base64," +
				image.Data
		: "";
};
...
scada.scheme.Renderer.prototype.createDom = function (
	component,
	renderContext,
) {};

// Refresh the component if it contains the specified images
scada.scheme.Renderer.prototype.refreshImages = function (
	component,
	renderContext,
	imageNames,
) {};
...
scada.scheme.Renderer.prototype.updateData = function (
	component,
	renderContext,
) {};
...
scada.scheme.SchemeRenderer.prototype = Object.create(
	scada.scheme.Renderer.prototype,
);
scada.scheme.SchemeRenderer.constructor = scada.scheme.SchemeRenderer;

scada.scheme.SchemeRenderer.prototype._setTitle = function (
	title,
	renderContext,
) {
	if (title && renderContext.schemeEnv.viewHub) {
		document.title =
			title + " - " + renderContext.schemeEnv.viewHub.getEnv().productName;
		...
		renderContext.schemeEnv.viewHub.notify(
...
scada.scheme.SchemeRenderer.prototype._calcScale = function (
	component,
	scaleType,
	scaleValue,
) {
...
scada.scheme.SchemeRenderer.prototype.createDom = function (
	component,
	renderContext,
) {
...
scada.scheme.SchemeRenderer.prototype.refreshImages = function (
	component,
	renderContext,
	imageNames,
) {
...
scada.scheme.SchemeRenderer.prototype.updateDom = function (
	component,
	renderContext,
) {
	if (component.dom) {
...
scada.scheme.SchemeRenderer.prototype.setScale = function (
	component,
	scaleType,
	scaleValue,
) {
...
scada.scheme.ComponentRenderer.prototype = Object.create(
	scada.scheme.Renderer.prototype,
);
...
scada.scheme.ComponentRenderer.prototype._getDynamicColor = function (
	color,
	cnlNum,
	renderContext,
) {
	if (color) {
		if (color === this.STATUS_COLOR) {
			var curCnlDataExt = renderContext.curCnlDataMap
				? renderContext.curCnlDataMap.get(cnlNum)
				: null;
...
scada.scheme.ComponentRenderer.prototype.setDynamicForeColor = function (
	jqObj,
	foreColor,
	cnlNum,
	renderContext,
	...
	this.setForeColor(
		jqObj,
		this._getDynamicColor(foreColor, cnlNum, renderContext),
		opt_removeIfEmpty,
	);
};

// Set background color of the jQuery object that may depend on input channel status
scada.scheme.ComponentRenderer.prototype.setDynamicBackColor = function (
	jqObj,
	backColor,
	cnlNum,
	renderContext,
	...
	this.setBackColor(
		jqObj,
		this._getDynamicColor(backColor, cnlNum, renderContext),
		opt_removeIfEmpty,
	);
};

// Set border color of the jQuery object that may depend on input channel status
scada.scheme.ComponentRenderer.prototype.setDynamicBorderColor = function (
	jqObj,
	borderColor,
	cnlNum,
	renderContext,
	...
	this.setBorderColor(
		jqObj,
		this._getDynamicColor(borderColor, cnlNum, renderContext),
		opt_removeIfEmpty,
	);
};

// Choose a color according to hover state
scada.scheme.ComponentRenderer.prototype.chooseColor = function (
	isHovered,
	color,
	colorOnHover,
) {
...
scada.scheme.ComponentRenderer.prototype.setWordWrap = function (
	jqObj,
	wordWrap,
) {
...
scada.scheme.ComponentRenderer.prototype.setToolTip = function (
	jqObj,
	toolTip,
) {
	if (toolTip) {
...
scada.scheme.ComponentRenderer.prototype.prepareComponent = function (
	jqObj,
	component,
	opt_skipSize,
	opt_skipColors,
	...
	var props = component.props;
	jqObj.addClass("comp").data("id", props.ID).css({
...
scada.scheme.ComponentRenderer.prototype.bindAction = function (
	jqObj,
	component,
	renderContext,
) {
			...
			jqObj.click(function () {
				switch (props.Action) {
					case Actions.DRAW_DIAGRAM:
						if (dialogs) {
							var date = viewHub.curViewDateMs
								? new Date(viewHub.curViewDateMs)
								: new Date();
					...
					case Actions.SEND_COMMAND_NOW:
						if (renderContext.schemeEnv) {
							renderContext.schemeEnv.sendCommand(
								props.CtrlCnlNum,
								component.cmdVal,
								renderContext.viewID,
								component.id,
							);
						} else {
...
scada.scheme.ComponentRenderer.prototype.setLocation = function (
	component,
	x,
	y,
) {
...
scada.scheme.ComponentRenderer.prototype.setWrapperProps = function (
	component,
) {
	// set location
...
scada.scheme.ComponentRenderer.prototype.setSize = function (
	component,
	width,
	height,
) {
...
scada.scheme.StaticTextRenderer.prototype = Object.create(
	scada.scheme.ComponentRenderer.prototype,
);
scada.scheme.StaticTextRenderer.constructor = scada.scheme.StaticTextRenderer;

scada.scheme.StaticTextRenderer.prototype.createDom = function (
	component,
	renderContext,
) {
	var props = component.props;
...
scada.scheme.StaticTextRenderer.prototype.setSize = function (
	component,
	width,
	height,
) {
...
scada.scheme.StaticPictureRenderer.prototype = Object.create(
	scada.scheme.ComponentRenderer.prototype,
);
scada.scheme.StaticPictureRenderer.constructor =
	scada.scheme.StaticPictureRenderer;

scada.scheme.StaticPictureRenderer.prototype.createDom = function (
	component,
	renderContext,
) {
...
scada.scheme.StaticPictureRenderer.prototype.refreshImages = function (
	component,
	renderContext,
	imageNames,
) {
...
scada.scheme.StaticPictureRenderer.prototype.setSize = function (
	component,
	width,
	height,
) {
	scada.scheme.ComponentRenderer.prototype.setSize.call(
		this,
		component,
		width,
		height,
...
scada.scheme.StaticSvgShapeRenderer = function () {
	scada.scheme.ComponentRenderer.call(this);
};

scada.scheme.StaticSvgShapeRenderer.prototype = Object.create(
	scada.scheme.ComponentRenderer.prototype
);

scada.scheme.StaticSvgShapeRenderer.constructor =
	scada.scheme.StaticSvgShapeRenderer;


scada.scheme.StaticSvgShapeRenderer.prototype.createSvgElement = function (shapeType, svgCode, props) {
	var svgElement;
...
scada.scheme.StaticSvgShapeRenderer.prototype.createDom = function (
	component,
	renderContext,
) {
	var props = component.props;
...
scada.scheme.UnknownComponentRenderer.prototype = Object.create(
	scada.scheme.Renderer.prototype,
);
scada.scheme.UnknownComponentRenderer.constructor =
	scada.scheme.UnknownComponentRenderer;
...
scada.scheme.rendererMap = new Map([
	...
	[
		"Scada.Scheme.Model.StaticPicture",
		new scada.scheme.StaticPictureRenderer(),
	],
	[
		"Scada.Scheme.Model.DynamicPicture",
		new scada.scheme.DynamicPictureRenderer(),
	],
	[
		"Scada.Scheme.Model.StaticPolygon",
		new scada.scheme.StaticPolygonRenderer(),
	],
	[
		"Scada.Scheme.Model.DynamicPolygon",
		new scada.scheme.DynamicPolygonRenderer(),
	],
	["Scada.Scheme.Model.StaticSvgShape", new scada.scheme.StaticSvgShapeRenderer()],
	[
		"Scada.Scheme.Model.UnknownComponent",
		new scada.scheme.UnknownComponentRenderer(),
	],
